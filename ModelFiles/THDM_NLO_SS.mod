...
C[S[3], S[3]]==
	{{0, (-I)*dZHAHA1},
	{0, (-I)*dZHAHA1*MHA2 - ((I/4)*Csc[beta]*Sec[beta]*(dTHL1*Cos[alpha - 3*beta] + 3*dTHL1*Cos[alpha + beta] + dTHH1*Sin[alpha - 3*beta] + 2*dMHA21*vev*Sin[2*beta] + 3*dTHH1*Sin[alpha + beta]))/vev}},
C[S[4], S[3]]==
